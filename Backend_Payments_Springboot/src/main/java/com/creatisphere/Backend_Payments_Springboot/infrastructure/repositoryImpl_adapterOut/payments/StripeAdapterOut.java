...
public class StripeAdapterOut implements PaymentPortOut {
    ...
    public Mono<Map<String, Object>> processPayment(PaymentRequest paymentRequest) {
        return Mono.fromCallable(() -> PaymentIntentCreateParams.builder()
                ...
                .map(params -> {
                    try {
                        ...
                        throw new PaymentProcessingException(
                                "Error en el procesamiento de pago Stripe: " + e.getMessage());
                    }
                })
    ...
    public Mono<Map<String, Object>> capturePayment(String paymentIntentId) {
        return Mono.just(Map.<String, Object>of(
                ...
                .onErrorMap(
                        e -> new PaymentProcessingException("Error en la captura de pago Stripe: " + e.getMessage()));
    }
}
