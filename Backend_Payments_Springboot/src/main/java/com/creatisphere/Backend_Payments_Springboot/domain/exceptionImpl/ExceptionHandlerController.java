package com.creatisphere.Backend_Payments_Springboot.domain.exceptionImpl;
...
import com.creatisphere.Backend_Payments_Springboot.application.exception.payments.PaymentProcessingException;
...
public class ExceptionHandlerController extends ResponseEntityExceptionHandler {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "404", description = "Payment method not found or not supported", content = @Content(schema = @Schema(implementation = Error.class)))
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "500", description = "Payment processing error: {specific error message}", content = @Content(schema = @Schema(implementation = Error.class)))
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "500", description = "Operation error: {specific error message}", content = @Content(schema = @Schema(implementation = Error.class)))
    })
