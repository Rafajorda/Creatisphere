package com.creatisphere.Backend_Payments_Springboot.presentation.controller_adapterIn.payments;
...
import com.creatisphere.Backend_Payments_Springboot.presentation.assembler.payments.PaymentAssembler;
...
public class PaymentController {
    ...
    @Operation(summary = "Process a new payment", description = "Initiates a payment process with Stripe or PayPal")
    @ApiResponses({
    ...
    @Operation(summary = "Capture a payment", description = "Captures a previously authorized PayPal payment")
    @ApiResponses({
    ...
    public Mono<PayPalCaptureResponse> capturePayment(
            @Parameter(description = "PayPal order ID to capture", example = "5O6P7Q8R9S0T") @PathVariable String orderId) {
